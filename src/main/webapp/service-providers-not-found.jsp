        ...
        <section class="page-section bg-light" id="team">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">We regret to inform you that no vendor has been registered yet</h3>
                </div>
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center"><p class="large text-muted">We are working hard to get vendors on-boarded !! Please bear with us and allow us few more days.</p></div>
                </div>
            </div>
        </section>
        <!-- Footer-->
